---
layout: workshop
title: "Wait - CSS Can Do That?"
category: web
published: true
sequence: 3
summary:
  "An interactive workshop for web developers covering advanced features of modern CSS: colour models, animation,
  filters, variables, properties, functions, blend modes, and much more."
bullets:
...
Dylan's been building web applications since before CSS was invented. He's online at [https://dylanbeattie.net/](https://dylanbeattie.net/) and on BlueSky as [@dylanbeatt.ie](https://bsky.app/profile/dylanbeatt.ie).
