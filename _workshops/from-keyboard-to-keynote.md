...
<h3>Part 1: Structure and Content</h3>
<ul>
    <li>How to design a talk: gather ideas, create a structure, figure out what works.</li>
    <li>Understanding constraints: format, timing, audiences</li>
    <li>Tools and techniques: language, rhetoric, storytelling, humour</li>
    <li>Effective rehearsal, dealing with nerves</li>
</ul>

<h3>Part 2: Slides and Media</h3>
<ul>
    <li>Creating effective slide decks: how to avoid “death by PowerPoint”</li>
    <li>Images, animation and photography</li>
    <li>Working with live demos</li>
